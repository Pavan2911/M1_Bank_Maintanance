...
void create_new_account()
{
    ...
    ptr = fopen("Bank_MainRecord.data", "a+");
account_no:
    system("clear");
...
{
    FILE *view;
    view = fopen("Bank_MainRecord.data", "r");
    int test = 0;
    system("clear");
...
void edit_details(void)
{
    int choice, test = 0;
    FILE *old, *newrec;
    old = fopen("Bank_MainRecord.dat", "r");
    ...
    fclose(old);
    fclose(newrec);
    remove("Bank_MainRecord.dat");
    rename("new.dat", "Bank_MainRecord.data");
...
void compute_transaction(void)
{
    int choice, test = 0;
    FILE *old, *newrec;
    old = fopen("Bank_MainRecord.data", "r");
    newrec = fopen("Bank_MainRecord.data", "w");
...
void see_details(void)
{
    ...
    float time;
    float intrst;
    ptr = fopen("Bank_MainRecord.data", "r");
